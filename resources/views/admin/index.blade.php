...
<div class="container py-4">
    ...
    <p class="text-muted mb-4">Bienvenue dans votre espace de gestion de la plateforme.</p>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3">
            <div class="card text-white shadow-sm text-center rounded" style="background-color: #4285f4;">
                <div class="card-body">
                    <h5 class="fw-bold text-white">Agences</h5>
                    <p class="fs-4 fw-bold" style="color: orange;">{{ $nombreAgences }}</p>
                </div>
            </div>
        </div>
