...
.property-price {
    ...
    font-weight: bold;
    color: #2c7be5;
    margin-top: auto; /* pousse le prix + bouton en bas */
}
.btn-view {
    margin-top: 0.8rem;
}
...
<div class="container mt-5 mb-5">
    <h2 class="mb-4 text-center">Toutes les propriétés publiées</h2>
    ...
    <div class="row">
            ...
            <div class="property-card w-100">
                ...
                <div class="property-content">
                    ...
                    <div class="property-price">
                        ...
                        <div class="btn-view">
                            <a href="{{ route('admin.proprietes.show', $propriete->id) }}" class="btn btn-primary btn-sm w-100">
                                Voir détails
                            </a>
                        </div>
                    </div>
        ...
        @empty
            <div class="col-12">
                <div class="alert alert-info text-center">Aucune propriété disponible.</div>
            </div>
        @endforelse
    </div>
</div>
