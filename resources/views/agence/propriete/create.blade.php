                    ...
                    <form action="{{ route('agence.propriete.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="nombre_de_chambres" class="form-control" value="{{ old('nombre_de_chambres') }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="salle_de_bains" class="form-control" value="{{ old('salle_de_bains') }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="proposition" class="form-control" value="{{ old('proposition') }}">
                                @error('proposition')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
