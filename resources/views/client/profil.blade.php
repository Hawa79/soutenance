        ...
        <div class="container">
            ...
            <form action="{{ route('client.update', Auth::user()->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="prenom" name="prenom" class="form-control" value="{{ old('prenom', Auth::user()->prenom) }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="telephone" name="telephone" class="form-control" value="{{ old('telephone', Auth::user()->telephone) }}">
                </div>

                <div class="form-group">
                    <label for="adresse">Adresse postale</label>
                    <input type="text" id="adresse" name="adresse" class="form-control" value="{{ old('adresse', Auth::user()->adresse) }}">
                </div>

                <div class="form-group">
                    <label for="sexe">Sexe</label>
                    <select id="sexe" name="sexe" class="form-control">
                        <option value="M" {{ old('sexe', Auth::user()->sexe) == 'M' ? 'selected' : '' }}>M</option>
                        <option value="Mme" {{ old('sexe', Auth::user()->sexe) == 'Mme' ? 'selected' : '' }}>Mme</option>
